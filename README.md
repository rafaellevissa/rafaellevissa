...
[English version / Versão em inglês](./README-english-version.md)
...
## [Por tecnologias](https://docs.google.com/presentation/d/1AxNHBtNAufnbei5YVt1XnSVmtTqxHkIK/edit?usp=sharing&ouid=108286114865654384665&rtpof=true&sd=true):
### Python:
- Experiência: Comecei a programar em Python com embarcados há mais de 10 anos atrás, no início com foco em dar aulas e pequenos projetos de automação, mas desde 2017 comecei a aplicar em projetos de grande escala e profissionalmente também com o uso de frameworks Web como Flask e Django. Possuo mais de 10 anos de experiência com Python, mas com o uso dos frameworks Flask e Django cerca de 4 anos.
...
- Experiência: Eu comecei há mais de 10 anos a trabalhar com Javascript para construção de sites e pequenos sistemas web. Ao longo dos meus anos de experiência trabalhando como desenvolvedor, sempre houve JS em quase todos os projetos, seja usando ReactJS ou VueJS com cerca de 4 anos de experiência ou NodeJS no back-end com cerca de 5 anos de experiência. Sobre o Typescript possuo cerca de 4 anos.
...
### GoLang:
- Experiência: Nos últimos anos me dediquei a alguns projetos que possuiam ao menos um microserviço ou mais em Golang, usando em arquiteturas de microserviços, construindo APIs Rest, gRPC, Websockets. Acumulei cerca de 3 anos de experiência.
...
### Php:
- Experiência: Comecei minha carreira Web com PHP e Laravel, durante os anos de projetos acumulei cerca de 4 anos de experiência. Também tive muito tempo de experiência dando aula com essa tecnologia.
...
### Devops:
- Experiência: Em todos os projetos ao qual participei, fiquei responsável além do código também com a infraestrutura, incluindo Serviços de Cloud como AWS, GCP,  serviços de mensageria como Kafka, SQS, RabbitMQ, Pipeline e processo de CI/CD, containerização com Docker e em alguns casos IaC (Infraestrura como código) incluindo Terraform e AWS CDK. Possuo mais 10 anos de experiência com a maioria dessas tecnologias.
- [Artigos](https://medium.com/@rafaellevissa/list/devops-and-cloud-d7e3ffffbabf)
- [Evento PEIE SP 2023](https://www.linkedin.com/pulse/peie-sp-2023-rafael-levi-costa/?trackingId=Bxs0Qx1MR%2FuwUV8pNwDFQQ%3D%3D)
- [Vídeos](https://www.youtube.com/playlist?list=PLemoLhVHAhFQKpqXZ8w6zg6FtdWimVpbv)

### Observação:
- Na maioria dos projetos e tempo de experiência citados acima houve intersecção entre os tempos contabilizados. Por exemplo, nos projetos ao qual trabalhei com Devops, normalmente também era responsável por codificar em determinada linguagem de programação, assim como em alguns projetos haviam serviços em mais de uma linguagem diferente, ao qual eu contribui.

## [Por categoria de negócio](https://docs.google.com/presentation/d/1XErHDrxEI-0mtmAZ2e2Vxo0tyy5mfCeF/edit?usp=sharing&ouid=108286114865654384665&rtpof=true&sd=true):
...
### Fintechs:
- [Artigos](https://medium.com/@rafaellevissa/list/fintech-apps-7ba355dcbb86)
- [Vídeos](https://www.youtube.com/playlist?list=PLemoLhVHAhFTPxmHjA15F_xHCvi60av2G)
- [Arquiteturas de projetos e tempo de experiência](https://github.com/rafaellevissa/Fintechs)

### EdTechs:
- [Vídeos](https://www.youtube.com/playlist?list=PLemoLhVHAhFSq62afLNrIAeIZs9s-g08n)
- [Arquiteturas de projetos e tempo de experiência](https://github.com/rafaellevissa/Edtech)

### HealthTechs:
- [Vídeos](https://www.youtube.com/playlist?list=PLemoLhVHAhFSI9P9ey81o2hBF2R9UQKYC)
- [Arquiteturas de projetos e tempo de experiência](https://github.com/rafaellevissa/HealthTech)

### ERPs, CRMs and Marketplaces:
- [Artigos](https://medium.com/@rafaellevissa/list/erps-crms-and-marketplaces-530b002a6d5e)
- [Vídeos](https://www.youtube.com/playlist?list=PLemoLhVHAhFTb95s9siklcZ-V4KZNss2e)
- [Arquiteturas de projetos e tempo de experiência](https://github.com/rafaellevissa/Gestao-Empresarial)
...
- [Vídeos](https://www.youtube.com/playlist?list=PLemoLhVHAhFTKb0m7wLmL_HzbUT-eKBIZ)
- [Repositórios de projetos de aplicativos com Flutter](https://github.com/rafaellevissa?tab=repositories&q=&type=&language=dart&sort=)
- [Aplicativo React Native para coletar dados do IBGE](https://github.com/rafaellevissa/ibgeSenai)
- [Aplicativo React Native com dados sobre Covid-19](https://github.com/rafaellevissa/appCorona)
- [Aplicativo React Native com integração com Youtube](https://github.com/rafaellevissa/senaiflix)
